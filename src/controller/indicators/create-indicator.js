...
export async function createIndicator(req,res){
    ...
    .query(`
        INSERT INTO indicators(lab_type_id, indicator_name, unit, test_method, limit_value, is_default)
        VALUES(@lab_type_id, @indicator_name, @unit, @test_method, @limit_value, @is_default)
        `)
